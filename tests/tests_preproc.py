...
class TestImitatePreprocessor(unittest.TestCase):
    ...
    def test_imitate_deletion(self):
        ...
        self.pproc_2.apply_stored_transformation(trafo)
        self.assertFalse('W0' in data_2.columns)
    ...
    def test_apply_stored_combination(self):
        ...
        self.pproc_2.apply_stored_transformation(trafo)
        data = self.pproc_2.data
        self.assertTrue('W01_Delta' in data.columns)
    ...
    def test_imitate_combination(self):
        ...
        self.pproc_2.apply_stored_transformation(trafo)
        self.assertTrue('W01_Delta' in data_2.columns)
        self.assertTrue(data_1.equals(data_2))
    ...
    def test_imitate_addition(self):
        ...
        self.pproc_2.apply_stored_transformation(trafo, vals)
        self.assertTrue('DoubleW0' in data_2.columns)
        self.assertTrue(data_1.equals(data_2))
